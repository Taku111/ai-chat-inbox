...
export default function ContactsPage() {
  ...
  useEffect(() => {
    getDocs(query(collection(db, COLLECTIONS.CONTACTS), orderBy('displayName')))
      .then(snap => {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <EmptyState icon={Users} title="No contacts" description="Contacts are created automatically when parents message you." />
        ) : (
          filtered.map(contact => (
            <div key={contact.id} className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 hover:bg-gray-50">
